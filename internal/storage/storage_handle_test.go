...
func (testSuite *StorageHandleTest) TestGetClient_Regional_EnforceDirectPath_DirectPathFails_FallbackToHTTP() {
	...
	sh := &storageClient{
		clientConfig: storageutil.StorageClientConfig{
			ClientProtocol:    cfg.GRPC,
			EnforceDirectPath: true,
			CustomEndpoint:    "http://localhost:54321",
			AnonymousAccess:   true,
		},
	}
...
func (testSuite *StorageHandleTest) TestGetClient_Regional_EnforceDirectPath_CachedDirectPathClient_Reused() {
...
func (testSuite *StorageHandleTest) TestGetClient_Regional_EnforceDirectPath_ContextCanceled_DoesNotFallbackToHTTP() {
	sh := &storageClient{
		clientConfig: storageutil.StorageClientConfig{
			ClientProtocol:    cfg.GRPC,
			EnforceDirectPath: true,
